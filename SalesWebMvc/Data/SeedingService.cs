...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Dolls");
            Department d3 = new Department(3, "Cars");
            Department d4 = new Department(4, "Balls");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Julia Roberts", "julia@gmail.com", new DateTime(1985, 8, 15), 3500.0, d2);
            Seller s3 = new Seller(3, "Michael jackson", "mike@gmail.com", new DateTime(1983, 6, 01), 2200.0, d3);
            Seller s4 = new Seller(4, "Harry Potter", "rariPota@gmail.com", new DateTime(1991, 5, 10), 4000.0, d4);
            Seller s5 = new Seller(5, "Hermione Granger", "leviosa@gmail.com", new DateTime(1992, 12, 18), 3000.0, d4);
            Seller s6 = new Seller(6, "Jack Sparrow", "caribe@gmail.com", new DateTime(1980, 3, 22), 3000.0, d3);
